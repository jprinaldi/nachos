...
BitMap* freeList;  // Data structure used to keep track of free physical pages
std::map<SpaceId, std::vector<std::string> > userProgramArgs;
#endif
...
//  Interrupt handler for the timer deviSIGTRAP example -perlce.
//  The timer device is
